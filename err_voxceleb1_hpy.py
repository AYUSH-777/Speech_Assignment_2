...
if __name__ == '__main__':
    ...
    voxceleb1h_dataset = preprocess_voxceleb1h_dataset()

    text_files = [file for file in os.listdir(data_folder) if file.endswith('.txt')]
    ...
    for sample in voxceleb1h_dataset:
